// Q2
// separate data path and control path (with a 2 state FSM)
...
assign sum_valid = (prev_state == BUSY) && (curr_state == IDLE);


// O/P of state 

assign N_mux_sel = (curr_state == IDLE) && N_valid;
assign i_mux_sel = (curr_state == IDLE) && N_valid;
assign sum_mux_sel = (curr_state == IDLE) && N_valid;
