...
module fir_4tap_all_roundoff #(parameter integer W = 16)(
    ...
    wire signed [(W-1):0] mul_out3 = ((h3 * x3) + (1 <<< (W-2))) >>> (W-1);
    
    wire signed [(W-1):0] add_out0 = ((mul_out0 + mul_out1));
    wire signed [(W-1):0] add_out1 = ((add_out0 + mul_out2));
    wire signed [(W-1):0] add_out2 = ((add_out1 + mul_out3));
