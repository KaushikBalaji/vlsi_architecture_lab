...
module fir_4tap_final_roundoff #(parameter integer W = 16)(
    ...
    // Rounding only at the final stage, W = 16
    ...
    wire signed [(2*W)+1:0] add_out1 = add_out0 + mul_out2;
    wire signed [(2*W)+2:0] add_out2 = add_out1 + mul_out3;
