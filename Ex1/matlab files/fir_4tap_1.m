...
for n = 1:N
    ...
    mul_out0 = bitshift((h0 * xin) + int32(16384), -15);
    mul_out1 = bitshift((h1 * x1) + int32(16384), -15);
    mul_out2 = bitshift((h2 * x2) + int32(16384), -15);
    mul_out3 = bitshift((h3 * x3) + int32(16384), -15);
...
fid = fopen('matlab_hexout_1.txt','w');
for n = 1:N
    fprintf(fid, '%04X\n', typecast(y(n),'uint16'));
end
fclose(fid);
